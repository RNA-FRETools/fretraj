...
Usage: pymol_vis.sh -c <structure file (.gro/.pdb)> -x <xtc trajectory> (optional) -v <pymol visualization file> (optional), -s <start,stop,stride (default 1,-1,1)>" 1>&2; exit 1; }
